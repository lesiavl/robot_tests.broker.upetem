...
def get_item_xpath(field_name, item_id):
    item_xpath = {
        ...
        'deliveryAddress.postalCode': "//*[contains(text(), '" + item_id + "')]//ancestor::table//tr[14]/td[2]/input",
        ...
        'deliveryAddress.streetAddress': "//*[contains(text(), '" + item_id + "')]//ancestor::table//tr[15]/td[2]/input",
